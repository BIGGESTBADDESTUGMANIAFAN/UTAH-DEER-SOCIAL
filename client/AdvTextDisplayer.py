...
class MarkupString:
    ...
    def __init__(self, string : str) -> None:
        self.TextWithFormat = string
        
        self.Opening_Formattings = re.findall("<.*?>", self.TextWithFormat)
        self.Closing_Formattings = re.findall("<\\.*?>", self.TextWithFormat)
        
    def __repr__(self) -> str:
        return self.TextWithFormat + str(self.formattings)
